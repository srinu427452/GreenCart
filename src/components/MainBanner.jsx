  ...
  return (
    <div className='relative'>
        ...
        md:justify-center pb-24 md:pb-0 px-4 md:pl-18 lg:pl-24 '>
            <h1 className='text-3x1 md:text-4xl lg:text-5xl font-bold text-center 
            md:text-left max-w-72 md:max-w-80 lg:max-w-105 leading-tight lg:leading-15'>Freshness You Can Trust, Savings You Love!</h1>
