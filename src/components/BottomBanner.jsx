...
const BottomBanner = () => {
  return (
    <div className='relative mt-24'>
      <img src={assets.bottom_banner_image} alt='Bottom-image' className='w-full hidden md:block' />
      <img src={assets.bottom_banner_image_sm} alt='Bottom-image' className='w-full block  md:hidden' />
